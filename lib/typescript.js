...
function convertType(swaggerType, swagger) {
    ...
    } else if (swaggerType.type === 'string' && swaggerType.format === 'date-time') {
        typespec.tsType = 'Date';
    ...
    typespec.isAtomic = typespec.isAtomic || _.includes(['string', 'number', 'boolean', 'any', 'Date'], typespec.tsType);
